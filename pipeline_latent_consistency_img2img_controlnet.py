...
class LatentConsistencyModelImg2ImgPipelineControlnet(
    ...
    def __call__(
        ...
        **kwargs,
        ...
        self.scheduler.set_timesteps(
            num_inference_steps, device, strength=strength
        )
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):          
                ...
                latents, denoised = self.scheduler.step(model_pred, t, latents, generator=generator, return_dict=False)
